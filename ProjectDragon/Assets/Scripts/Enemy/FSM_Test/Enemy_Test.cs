...
public class Enemy_Test : Monster
{
    ...
    [HideInInspector] public GameObject childDeadParticle;
    private bool DustParticle_Actuation = false;
    ...
    #region A* 이동시 부딪힌 사물과의 콜라이더 관계 끄기
    ...
    /// </summary>
    /// <returns></returns>
    protected IEnumerator PushStop_Func()
    {
